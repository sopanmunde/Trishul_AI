    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-72 p-0" align="start" side="top">
        <div className="p-3">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border border-zinc-100 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 mb-3">
          ...
          <div className="my-2 border-t border-zinc-200 dark:border-zinc-700/80" />
